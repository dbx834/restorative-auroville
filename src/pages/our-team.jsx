          ...
          <Container block noFade>
            <MainBlock>
              <div>
                ...
                <Image
                  src="https://www.joylivinglearning.org/static/nvcX56.d62cae0b.jpg"
                  style={{
                    height: "auto",
                    width: "100%",
                    border: 0,
                ...
                <p>
                  ...
                  exploring how we can live our lives in empowered and
                  co-creative ways. Nonviolent Communication (NVC) offers such a
                  clear, yet deeply powerful and transformative framework within
                  which to explore both our inner realities as well as outer
                  relationships. In addition to NVC, L'aura is also trained in
                  Restorative Circles and Sociocracy, and she applies these
                  approaches to her work with justice and governance in
                  Auroville.
                </p>
                <p>
                  L’aura has travelled and shared in different countries and
                  contexts, ranging from the corporate sector, to schools, to
                  NGOs working with women and street children, exploring NVC as
                  a means to transformation and sustainable change. Most of her
                  work has been in India, although she has also worked in Sri
                  Lanka, Nepal, Canada, USA, UK and Switzerland.
                </p>
                ...
                <p>
                  ...
                  and organized several large-scale international events here,
                  and has published NVC books and teaching material.
                </p>
                <p>
                  ...
                  introductory courses to Sociology, Anthropology and
                  Psychology. She specialized in the International Baccalaureate
                  (IB) Program (an internationally accredited program) and
                  taught senior IB students. She organized several
                  extra-curricular programs for the students, including
                  international travel programs, cultural outings, camping and
                  trekking trips, and cross-country running.
                </p>
                <p>
                  L'aura's personal interests lie in making deep connections
                  with people, living a meaningful and sustainable life,
                  contributing to community, and practicing yoga and being
                  physically active.
                </p>
                <h2>Janet</h2>
                <p>
