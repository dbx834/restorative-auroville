...
const Page = () => (
  <StandardPage className="" seoData={seoData}>
    ...
    <p>
      ...
      resolving conflicts, we trust that it will offer a way forward and support
      a shift in how we hold space for conflict and transformation.
    </p>
    <p>
      ...
      hold conflict as a community. Our project includes research, teaching,
      sharing of information, large-scale community involvement and events,
      experiments, testimonials, and more.
    </p>
    <p>
      After having studied and practiced the Restorative Circles process for 5
      years, we officially launched Restorative Auroville as a public service in
      September 2015. Because much of this work depends on how it’s received in
      the community, we do not know exactly where it will lead us and how long
      it will take.
    </p>
    <h2 className="mask-p">Aims & Objectives:</h2>
    <ul className="mask-p">
      <li>
        To co-create a Justice System in Auroville that reflects our values and
        is effective
      </li>
      ...
      <li>
        To understand what is unique about Auroville and how to adapt RC to suit
        our needs and ideals
      </li>
      <li>
