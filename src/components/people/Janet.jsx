  ...
  <div>
    ...
    <p>
      <i>
        ...
        1968, four months after the inauguration of Auroville. I stayed in the
        Sri Aurobindo Ashram until September and then moved to Auroville, which
        at the time was an eroded, barren plateau with a few impoverished
        villages and less than ten people from other parts of the world who had
        come to build the new city.
      </i>
    </p>
    <p>
      <i>
    ...
    <p style={{ marginBottom: 0 }}>
      <i>
        ...
        understood in Auroville, and helping as a co-facilitator in many
        Circles.
      </i>
    </p>
  </div>
