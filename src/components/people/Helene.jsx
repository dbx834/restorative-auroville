  ...
  <div>
    ...
    <p>
      ...
      <i>
        ...
        inside myself, trying to understand who I was and what happiness was.
      </i>
    </p>
    <p>
      <i>
        It has been a long journey that brought me in 2004 to Pondicherry where
        I stayed 6 years connected with Sri Aurobindo Ashram in order to get a
    ...
    <p style={{ marginBottom: 0 }}>
      <i>
        ...
        with conflicts, to open more my understanding and my heart to others. I
        found it was helping people to discover some parts of themselves that
        they were not aware of. RC can be a personal transformation process as
        well as a community transformation process based on being honest,
        listening and accepting each other and their differences. Not to ignore
        conflict is so important for being able to live human unity in oneself
