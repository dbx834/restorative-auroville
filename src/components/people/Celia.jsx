  ...
  <div>
    ...
    <p>
      ...
      <i>
        ...
        technique was far from perfect but it enable us to look at our wounds,
        express them to the others and be heard. It was a very nice experience
        for myself and i also learnt to offer it for others. I always had an
        attraction for conflict resolution and deep communication. I even
        discovered later that I am "the Mediator" in the MBTI personality types.
      </i>
    </p>
    <p style={{ marginBottom: 0 }}>
      <i>
        When I arrived in Auroville I first heard about Nonviolent Communicaton
        and I fell in love with it and amazed by the person teaching it
        (L'aura), this is what I needed! I learnt how to listen deeply to
